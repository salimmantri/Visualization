...
(function (root, factory) {
    ...
    Pie.prototype.update = function (domNode, element) {
        ...
        var arc = element.selectAll(".arc").data(this.d3Pie(mappedData), function (d) { return d.data[0]; });
        ...
        //  Label Lines  ---
        if (context.outerText()) {
            var lines = element.selectAll("line").data(this.d3Pie(mappedData), function (d) { return d.data[0]; });
