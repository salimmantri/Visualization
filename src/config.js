require.config({
    ...
    paths: {
        ...
        "d3-cloud": "../bower_components/d3-cloud/d3.layout.cloud",
...
case "cdn.rawgit.com":
    require.config({
        paths: {
            ...
            "d3-cloud": "//" + window.location.hostname + "/jasondavies/d3-cloud/v1.1.2/d3.layout.cloud",
            ...
            "simpleheat": "https://raw.githubusercontent.com/mourner/simpleheat/gh-pages/simpleheat.js",
