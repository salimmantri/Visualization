...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "../common/HTMLWidget", "css!./CalendarHeatMap"], factory);
    } else {
        root.other_CalendarHeatMap = factory(root.common_HTMLWidget);
    }
    ...
    CalendarHeatMap.prototype.publish("stringProp", "defaultValue", "string", "Sample Property");
