...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.map_ChoroplethStatesHeatMap = factory(root.layout_Layered, root.layout_AbsoluteSurface, root.map_ChoroplethStates, root.other_HeatMap);
    }
}(this, function (Layered, AbsoluteSurface, ChoroplethStates, HeatMap) {
    function ChoroplethStatesHeatMap(target) {
        Layered.call(this);
    }
    ChoroplethStatesHeatMap.prototype = Object.create(Layered.prototype);
    ChoroplethStatesHeatMap.prototype.constructor = ChoroplethStatesHeatMap;
    ChoroplethStatesHeatMap.prototype._class += " map_ChoroplethStatesHeatMap";

    ChoroplethStatesHeatMap.prototype.testData = function () {
        var testData = [
    ...
    return ChoroplethStatesHeatMap;
}));
