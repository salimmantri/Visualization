...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "require", "./amchartFactory", "./c3chartFactory", "./plotlyFactory", "./chartFactory", "./compositeFactory", "./commonFactory", "./formFactory", "./googleFactory", "./graphFactory", "./layoutFactory", "./mapFactory", "./marshallerFactory", "./otherFactory", "./treeFactory"], factory);
    } else {
...
}(this, function (d3, require, amchartFactory, c3chartFactory, plotlyFactory, chartFactory, compositeFactory, commonFactory, formFactory, googleFactory, graphFactory, layoutFactory, mapFactory, marshallerFactory, otherFactory, treeFactory) {
    var bundles = { common: commonFactory, chart: chartFactory, amchart: amchartFactory, google: googleFactory, c3chart: c3chartFactory, plotly: plotlyFactory, composite: compositeFactory, map: mapFactory, tree: treeFactory, graph: graphFactory, other: otherFactory, form: formFactory, layout: layoutFactory, marshaller: marshallerFactory };
    var bundlesCatMap = {};
