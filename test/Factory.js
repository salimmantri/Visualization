...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "require", "./amchartFactory", "./c3chartFactory", "./chartFactory", "./compositeFactory", "./commonFactory", "./formFactory", "./googleFactory", "./graphFactory", "./layoutFactory", "./mapFactory", "./marshallerFactory", "./otherFactory", "./treeFactory", "./mdlFactory"], factory);
    } else {
        root.test_Factory = factory(root.d3, root.require, root.test_amchartFactory, root.test_c3chartFactory, root.test_chartFactory, root.test_compositeFactory, root.test_commonFactory, root.test_formFactory, root.test_googleFactory, root.test_graphFactory, root.test_layoutFactory, root.test_mapFactory, root.test_marshallerFactory, root.test_otherFactory, root.test_treeFactory, root.test_mdlFactory);
    }
}(this, function (d3, require, amchartFactory, c3chartFactory, chartFactory, compositeFactory, commonFactory, formFactory, googleFactory, graphFactory, layoutFactory, mapFactory, marshallerFactory, otherFactory, treeFactory, mdlFactory) {
    var bundles = { common: commonFactory, chart: chartFactory, amchart: amchartFactory, google: googleFactory, c3chart: c3chartFactory, composite: compositeFactory, map: mapFactory, tree: treeFactory, graph: graphFactory, other: otherFactory, form: formFactory, layout: layoutFactory, marshaller: marshallerFactory, mdl: mdlFactory };
    var bundlesCatMap = {};
