...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["src/common/SVGWidget"], factory);
    } else {
    ...
    function HPCCBadge() {
        SVGWidget.call(this);
        this._class = "impress_HPCCBadge";
    };
    HPCCBadge.prototype = Object.create(SVGWidget.prototype);
    ...
    HPCCBadge.prototype.enter = function (domNode, element) {
        var retVal = SVGWidget.prototype.enter.apply(this, arguments);
    ...
    HPCCBadge.prototype.update = function (domNode, element) {
        var retVal = SVGWidget.prototype.update.apply(this, arguments);
